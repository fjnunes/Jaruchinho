...
flags.DEFINE_string('image_dir', '/Users/jaruche/Desktop/images',
                           """Path to folders of labeled images.""")
flags.DEFINE_string('output_graph', '/tmp/output_graph.pb',
                           """Where to save the trained graph.""")
flags.DEFINE_string('output_labels', '/tmp/output_labels.txt',
